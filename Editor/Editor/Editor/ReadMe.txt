...
EditorDoc.h, EditorDoc.cpp - the document
    These files contain your CEditorDoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CEditorDoc::Serialize).

EditorView.h, EditorView.cpp - the view of the document
    These files contain your CEditorView class.
    CEditorView objects are used to view CEditorDoc objects.
